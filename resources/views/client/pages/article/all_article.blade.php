...
@section('content')
<div class="home">
    <div class="home_background parallax-window" data-parallax="scroll" data-image-src="client_assets/images/category.jpg"
        data-speed="0.8">
        <img src="client_assets/images/category.jpg" alt="">
    </div>
</div>
...
<div class="page_content">
    <div class="container">
                        ...
                        <div class="section_panel d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="section_tags ml-auto">
                                <ul>
                                    ...
                                    <li><a href="{{ route('cate_article',$item->slug) }}.html">{{ $item->name }}</a></li>
                                    @endforeach
                        ...
                        <div class="section_content">
                            <div class="grid clearfix">
                                ...
                                <div class="card card_small_with_image grid-item">
                                    <img class="card-img-top" src="client_assets/images/post_10.jpg" alt="">
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                ...
                                <!-- Small Card With Image -->
                                <div class="card card_small_with_image grid-item">
                                    <img class="card-img-top" src="client_assets/images/post_15.jpg" alt="">
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                                Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a>
                                ...
                                <!-- Small Card With Image -->
                                <div class="card card_small_with_image grid-item">
                                    <img class="card-img-top" src="client_assets/images/post_13.jpg"
                                ...
                                <div class="card card_default card_small_with_background grid-item">
                                    <div class="card_background" style="background-image:url(client_assets/images/post_11.jpg)"></div>
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                                Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a>
                                ...
                                <!-- Small Card With Background -->
                                <div class="card card_default card_small_with_background grid-item">
                                    <div class="card_background" style="background-image:url(client_assets/images/post_16.jpg)"></div>
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                                Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a>
                                ...
                                <!-- Small Card With Image -->
                                <div class="card card_small_with_image grid-item">
                                    <img class="card-img-top" src="client_assets/images/post_14.jpg" alt="">
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                                Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a>
                                ...
                                <div class="card card_default card_default_with_background grid-item">
                                    <div class="card_background" style="background-image:url(client_assets/images/post_12.jpg)"></div>
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                ...
                                <!-- Default Card With Background -->
                                <div class="card card_default card_default_with_background grid-item">
                                    <div class="card_background" style="background-image:url(client_assets/images/post_6.jpg)"></div>
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                                Turbulent Mind Depict One of the Most</a></div>
                                ...
                                <!-- Small Card With Background -->
                                <div class="card card_default card_small_with_background grid-item">
                                    <div class="card_background" style="background-image:url(client_assets/images/post_19.jpg)"></div>
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                                Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a>
                                ...
                                <!-- Small Card With Image -->
                                <div class="card card_small_with_image grid-item">
                                    <img class="card-img-top" src="client_assets/images/post_5.jpg" alt="">
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                                Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a>
                                ...
                                <!-- Small Card With Image -->
                                <div class="card card_small_with_image grid-item">
                                    <img class="card-img-top" src="client_assets/images/post_20.jpg"
                                        alt="https://unsplash.com/@jakobowens1">
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                ...
                                <!-- Small Card With Background -->
                                <div class="card card_default card_small_with_background grid-item">
                                    <div class="card_background" style="background-image:url(client_assets/images/post_4.jpg)"></div>
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                                Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a>
                                ...
                                <!-- Small Card With Background -->
                                <div class="card card_default card_small_with_background grid-item">
                                    <div class="card_background" style="background-image:url(client_assets/images/post_21.jpg)"></div>
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                                Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a>
                                ...
                                <!-- Small Card With Image -->
                                <div class="card card_small_with_image grid-item">
                                    <img class="card-img-top" src="client_assets/images/post_22.jpg" alt="">
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                                Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a>
                                ...
                                <!-- Default Card With Background -->
                                <div class="card card_default card_default_with_background grid-item">
                                    <div class="card_background" style="background-image:url(client_assets/images/post_23.jpg)"></div>
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                                Turbulent Mind Depict One of the Most</a></div>
                                ...
                                <!-- Default Card With Background -->
                                <div class="card card_default card_default_with_background grid-item">
                                    <div class="card_background" style="background-image:url(client_assets/images/post_24.jpg)"></div>
                                    <div class="card-body">
                                        <div class="card-title card-title-small"><a href="">How Did van
                                                Gogh’s
                                                Turbulent Mind Depict One of the Most</a></div>
                ...
                <div class="sidebar">
                                            ...
                                            <a href="">
                                                <div
                                                    ...
                                                    <div class="side_post_image">
                                                        <div><img src="client_assets/images/top_1.jpg" alt=""></div>
                                                    </div>
                                        ...
                                        <div class="side_post">
                                            <a href="">
                                                <div
                                                    class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                    <div class="side_post_image">
                                                        <div><img src="client_assets/images/top_2.jpg" alt=""></div>
                                                    </div>
                                                    <div class="side_post_content">
                                                        <div class="side_post_title">How Did van Gogh’s Turbulent Mind
                                                        </div>
                                        ...
                                        <div class="side_post">
                                            <a href="">
                                                <div
                                                    class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                    <div class="side_post_image">
                                                        <div><img src="client_assets/images/top_3.jpg" alt=""></div>
                                                    </div>
                                                    <div class="side_post_content">
                                                        <div class="side_post_title">How Did van Gogh’s Turbulent Mind
                                                        </div>
                                        ...
                                        <div class="side_post">
                                            <a href="">
                                                <div
                                                    class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                    <div class="side_post_image">
                                                        <div><img src="client_assets/images/top_4.jpg" alt=""></div>
                                                    </div>
                                                    <div class="side_post_content">
                                                        <div class="side_post_title">How Did van Gogh’s Turbulent Mind
                                                        </div>
                    ...
                    <div class="sidebar_section">
                        <div class="advertising">
                            <div class="advertising_background" style="background-image:url(client_assets/images/post_17.jpg)"></div>
                                        ...
                                        <div class="side_post">
                                            <a href="">
                                                <div
                                                    class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                    <div class="side_post_image">
                                                        <div><img src="client_assets/images/vid_1.jpg" alt=""></div>
                                                    </div>
                                                    <div class="side_post_content">
                                                        <div class="side_post_title">How Did van Gogh’s Turbulent Mind
                                                        </div>
                                        ...
                                        <div class="side_post">
                                            <a href="">
                                                <div
                                                    class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                    <div class="side_post_image">
                                                        <div><img src="client_assets/images/vid_2.jpg" alt=""></div>
                                                    </div>
                                                    <div class="side_post_content">
                                                        <div class="side_post_title">How Did van Gogh’s Turbulent Mind
                                                        </div>
                                        ...
                                        <div class="side_post">
                                            <a href="">
                                                <div
                                                    class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                    <div class="side_post_image">
                                                        <div><img src="client_assets/images/vid_3.jpg" alt=""></div>
                                                    </div>
                                                    <div class="side_post_content">
                                                        <div class="side_post_title">How Did van Gogh’s Turbulent Mind
                                                        </div>
                                        ...
                                        <div class="side_post">
                                            <a href="">
                                                <div
                                                    class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
                                                    <div class="side_post_image">
                                                        <div><img src="client_assets/images/vid_4.jpg" alt=""></div>
                                                    </div>
                                                    <div class="side_post_content">
                                                        <div class="side_post_title">How Did van Gogh’s Turbulent Mind
                                                        </div>
      ...
      day                                               </div>
        ...
        <div class="container thefuck">
            <div class="row row-lg-eq-height">
              <div class="col-9">
                @foreach ($cate_article as $item)
          
                <div class="card card_small_with_image grid-item m-1 kv-2">
                    ...
                    <div class="card-body">
                      ...
                      <small class="post_meta"
                        ...
                        ><span>{{$item->created_at->format('M j, Y \a\t g:i a') ?? ''}}</span></small
                      >
                    </div>
                  </div>
                @endforeach
